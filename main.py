...
bot = telebot.TeleBot('8177087339:AAHhdvBraVBHEdik9UU9ocIu7fmpswfbWxQ')
...
COOLDOWN_PERIOD = 300 # set cooldown after one attack 
ATTACK_TIME = 240 # set max attack time for users
...
def generate_key(duration, length=7):
    ...
    return f"MEG-{duration.upper()}-{key.upper()}"
